...
| Milestone 6A: straight cylindrical-lumen point-goal navigation | Functionally integrated and runtime verified for the default software-simulation target | Straight analytical cylindrical lumen, complete-backbone clearance, whole-backbone MPPI running cost, whole-final-backbone terminal collision surcharge, visualization, cylinder-navigation metrics, automatic matched baseline/candidate evaluation; focused tests passed: `ctr_mppi_controller` 121, `ctr_model` 3, `ctr_sim` 4, `ctr_evaluation` 107, `ctr_bringup` 44, total 279; direct cylindrical-lumen tests 28; default target succeeded for seeds 11, 22, and 33 with zero collisions and valid comparisons; no hardware node, strict JSON, and clean process cleanup verified | Milestone 6A.1 multi-target robustness; axial/lateral target tuning; real-time performance; measured CTR/lumen parameters; curved lumen; obstacle geometry; tactile sensing; safety retreat; hardware interface; physical validation |
...
| CYL-001 | Milestone 6A.1 multi-target robustness | Default cylinder target succeeded for seeds 11, 22, and 33; axial and lateral targets were collision-free but did not meet the 0.003 m goal tolerance within 20 s | Robustness protocol and tuning/acceptance plan | Repeated matched cylinder-navigation batches across default, axial, lateral, and additional validated targets | Controller | High |
| CYL-002 | Axial/lateral target tuning | Axial target final error `0.003776 m`; lateral target final error `0.004218 m`; both missed the 0.003 m tolerance in 20 s | Bounded tuning or duration/profile decision | Milestone 6A.1 target-specific tuning report without weakening safety or compatibility checks | Controller | High |
