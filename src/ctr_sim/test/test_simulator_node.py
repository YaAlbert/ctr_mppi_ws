...
class SimulatorNodeLumenRuntimeTest(unittest.TestCase):
    ...
    def test_curved_marker_array_skips_cylinder_specific_markers(self):
        ...
        self.assertNotIn("lumen_closest_pair", namespaces)
        self.assertNotIn("lumen_status", namespaces)
    ...
    def test_no_lumen_clears_stale_curved_static_markers_with_targeted_deletes(self):
        ...
        self.assertEqual(CURVED_STATIC_LUMEN_MARKER_KEYS, tuple((marker.ns, marker.id) for marker in deletes))
